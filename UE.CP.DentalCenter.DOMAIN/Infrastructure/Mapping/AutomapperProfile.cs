...
namespace UE.CP.DentalCenter.DOMAIN.Infrastructure.Mapping
{
    public class AutomapperProfile : Profile
    {
        public AutomapperProfile()
        {
            ...
            CreateMap<PersonalAdmDTO, PersonalAdm>();
            CreateMap<PersonalAdm, PersonalAdmDTO>(); //PERSONAL ADMINISTRATIVO
            ...
            CreateMap<LoginGetAShowDTO, Login>();
            CreateMap<Login, LoginGetAShowDTO>();
